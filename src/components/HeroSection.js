    ...
    return (
        <div className="hero-section">
            ...
            <h1>Property valuation <span style={{ color: 'aqua' }}>Simplified</span></h1>
                <h6>Get the preliminary value of your property in just a few clicks</h6>
                <button className="cta-button">Know your property value</button>
                {/* New Info Container */}
                <div className="info-container">
                    <p>" One Click solution for all your valuation requirements including Sale or Purchase of Property, 
                    Capital Gain Assessment, Insurance Purpose, Valuation for Dispute, across 50 cities in India. " </p>
                </div>
            </div>
